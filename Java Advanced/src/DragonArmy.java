...
public class DragonArmy {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Map<String, DragonArmy>> map = new LinkedHashMap<>();
        ...
        for (int i = 0; i < n; i++) {
            ...
            map.get(type).put(name, new DragonArmy(damage, health, armor));
        }
    ...
    private static String getAverageStats(Map<String, DragonArmy> map) {
        double averageDamage = 0;
        double averageHealth = 0;
        double averageArmor = 0;

        for (DragonArmy d : map.values()) {
